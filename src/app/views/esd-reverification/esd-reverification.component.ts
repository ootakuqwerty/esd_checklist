...
export class EsdReverificationComponent {
  ...
  openModal(id: any) {
    ...
    this.modalReference = this.modalService.open(this.confirmModal, { ariaLabelledBy: 'modal-basic-title', centered: true, size: 'lg', backdrop: 'static', keyboard: false });
  ...
  openUploadedModal(item: any) {
    ...
    this.modalReference = this.modalService.open(this.uploadedModal, { ariaLabelledBy: 'modal-basic-title', centered: true, size: 'lg', backdrop: 'static', keyboard: false });
    this.modalReference.result.then((result: any) => {
    }, (reason: any) => {
  ...
  onClickAddSignature(type: any) {
    if (type == 'auditProperAuditor') {
      ...
      this.addSignatureData.image = '../../../assets/images/esd_personnel/' + this.model.AuditProperAuditor + '.png';
      ...
      this.addSignatureData.image = '../../../assets/images/esd_personnel/' + this.model.AuditProperLeadAuditor + '.png';
      ...
      this.addSignatureData.image = '../../../assets/images/esd_personnel/' + this.model.AuditProperProcessOwner + '.png';
      ...
      this.addSignatureData.image = '../../../assets/images/esd_personnel/' + this.model.AuditVerificationProcessOwner + '.png';
    } else if (type == 'auditVerificationLeadAuditor') {
      this.addSignatureData.status = this.model.AuditVerificationLeadOwnerSigned
      this.addSignatureData.type = type
      this.addSignatureData.title = 'Audit Verification Lead Auditor Signature';
      this.addSignatureData.image = '../../../assets/images/esd_personnel/' + this.model.AuditVerificationLeadAuditor + '.png';
      ...
      this.addSignatureData.image = '../../../assets/images/esd_personnel/' + this.model.AuditVerificationEsdCoordinator + '.png';
    }
    this.addSignatureData.error = false;
    this.modalReference = this.modalService.open(this.signatureModal, { ariaLabelledBy: 'modal-basic-title', centered: true, size: 'lg', backdrop: 'static', keyboard: false });
    this.modalReference.result.then((result: any) => {
      this.spinner.show()
      if (this.addSignatureData.type == 'auditProperAuditor') {
        ...
        this.model.AuditVerificationLeadOwnerSigned = result;
