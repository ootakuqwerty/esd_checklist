...
@Component({
  selector: 'app-sga-patrol-form-list',
  templateUrl: './sga-patrol-form-list.component.html',
  styleUrls: ['./sga-patrol-form-list.component.scss'],
  providers: [DatePipe]
})
export class SgaPatrolFormListComponent {
